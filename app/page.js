    ...
    <div className="space-y-14">
      ...
      <section className="section-card">
        <div className="mb-6 flex items-end justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-rose-500">Featured Cakes</p>
            <h2 className="text-3xl font-bold">Fresh Favorites from Our Bakery</h2>
          </div>
          <Link href="/menu" className="text-sm font-semibold text-rose-600 hover:text-rose-700">
            View Full Menu
          </Link>
        </div>
      ...
      <section>
        <div className="mb-6">
          <p className="text-sm font-semibold uppercase tracking-wide text-emerald-600">Cake Categories</p>
      ...
      <section className="section-card">
        <div className="mb-6">
          <p className="text-sm font-semibold uppercase tracking-wide text-orange-500">Happy Customers</p>
      ...
      <section>
        <div className="mb-6 flex items-end justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-rose-500">Gallery Preview</p>
            <h2 className="text-3xl font-bold">Handmade Beauty in Every Slice</h2>
          </div>
          <Link href="/gallery" className="text-sm font-semibold text-rose-600 hover:text-rose-700">
            Explore Gallery
          </Link>
        </div>
      ...
      <section className="section-card grid items-center gap-6 bg-gradient-to-r from-rose-100 via-orange-100 to-emerald-50 md:grid-cols-2">
        <div>
          <p className="text-sm font-semibold uppercase tracking-wide text-rose-600">Instagram Preview</p>
      ...
      <section className="rounded-2xl bg-rose-200 p-8 text-center shadow-lg dark:bg-rose-900/40">
        ...
        <Link
          href="/order"
          className="mt-5 inline-flex rounded-full bg-rose-600 px-6 py-3 font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-rose-700"
        >
          Order a Cake
        </Link>
      </section>
